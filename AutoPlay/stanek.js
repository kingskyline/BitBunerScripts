...
const argsSchema = [
    ...
    // By default, starting an augmentation with stanek.js will still spawn AutoPlay/daemon.js, but will instruct it not to schedule any hack cycles against home by 'reserving' all its RAM
    ...
    // When stanek completes, it will run AutoPlay/daemon.js again (which will terminate the initial ram-starved daemon that is running)
